...
<h1 class="text-center">DANH SÁCH NHÀ ĐÃ BÁN</h1>
<hr>
<div class="panel panel-default">
    ...
    ?>
        <div class="col-xs-12 col-md-3 col-sm-12 image-product">
            ...
            <a href="{{URL::to('/')}}/{{ $tinbds->id }}"><img src="{{ URL::to('/') }}/public/images/{{ $images[0] }}" class="img-thumbnail" alt="Responsive image"></a>
            <?php }else{ ?>
            <a href="{{URL::to('/')}}/{{ $tinbds->id }}"><img src="{{ URL::to('/') }}/public/images/home128_3.png" class="img-thumbnail" alt="Responsive image"></a>
            <?php } ?>
            <div class="row"> 
    ...
    <?php }else{ ?>
        <div class="col-xs-12 col-md-12 col-sm-12 text-center">Hiện chưa có bất động sản nào đã bán!</div>
    <?php } ?>
